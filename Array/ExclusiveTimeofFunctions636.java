...
public class ExclusiveTimeofFunctions636 {
	...
	public static void main(String[] args) {
		...
		System.out.println(Arrays.toString(cn.exclusiveTime2(3, new ArrayList<String>(
				Arrays.asList(new String[] { "0:start:0", "1:start:2", "2:start:5", "2:end:10", "1:end:15", "0:end:26" })))));
		// System.out.println(Arrays.toString(cn.exclusiveTime(1, new
