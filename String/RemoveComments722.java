...
public class RemoveComments722 {
	...
	public static void main(String[] args) {
		...
		utils.printLine(cn.removeComments(new String[] {"/*Test program */", "int main()", "{ ", "  // variable declaration ", "int a, b, c;", "/* This is a test", "   multiline  ", "   comment for ", "   testing */", "a = b + c;", "}"}).toString());
